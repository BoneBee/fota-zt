...
public class TaskServiceImpl implements TaskService {
    ...
    public TaskBaseEntity getTaskDetaile(String taskId) {
        TaskBaseEntity tbentity = taskMapper.getTaskDetaile(taskId);
        String CreateBy = getUserRealName(tbentity.getCreateBy());
        tbentity.setCreateBy(CreateBy);
        return tbentity;
    }
    ...
    public List<PackageByCarTypeEntity> getPackageByCarType(String carTypeId) {
        List<PackageByCarTypeEntity> list=taskMapper.getPackageByCarType(carTypeId);
        for ( PackageByCarTypeEntity item : list){
            String CreateBy = getUserRealName(item.getCreateBy());
